...
def upload_results(json_dir, spreadsheet_id, sheet_name):
    ...
    for jf in json_files:
        ...
        for i in range(total_items):
            ...
            # Round 1 Grader
            r1_score_raw, r1_rationale = extract_score_and_rationale(g_string_r1)
            r1_score = convert_grader_score(r1_score_raw, True)
            
            # Round 1 Evaluator
            r1_was_evaluated = bool(e_string_r1)
            r1_eval_score_raw, r1_eval_rat_raw, r1_eval_reason = extract_eval_verdicts(e_string_r1)
            r1_eval_score = convert_eval_score_verdict(r1_eval_score_raw, r1_was_evaluated)
            r1_eval_rat = convert_eval_rationale_verdict(r1_eval_rat_raw, r1_was_evaluated)

            # Round 2 Grader
            r2_score_raw, r2_rationale = extract_score_and_rationale(g_string_r2)
            r2_score = convert_grader_score(r2_score_raw, False)

            # Round 2 Evaluator
            r2_was_evaluated = bool(e_string_r2)
            r2_eval_score_raw, r2_eval_rat_raw, r2_eval_reason = extract_eval_verdicts(e_string_r2)
            r2_eval_score = convert_eval_score_verdict(r2_eval_score_raw, r2_was_evaluated)
            r2_eval_rat = convert_eval_rationale_verdict(r2_eval_rat_raw, r2_was_evaluated)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dir", default="results", help="Directory containing JSON results")
    parser.add_argument("--sheet_id", default=SPREADSHEET_ID, help="Google Sheet ID")
    parser.add_argument("--sheet_name", default=SHEET_NAME, help="Worksheet Name")
